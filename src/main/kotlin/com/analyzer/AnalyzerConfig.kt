...
object AnalyzerConfig {
    ...
    /**
     * Коллеги, которых не нужно учитывать в сводке «Активность тестировщиков
     * по месяцам» HTML-отчёта (например, уволившиеся). Можно указывать
     * e-mail или отображаемое имя из AUTHOR_NAMES; если у человека
     * несколько e-mail, объединённых через AUTHOR_NAMES, достаточно
     * указать любой из них — он исключается целиком. На остальные
     * секции отчёта не влияет.
     */
