...
object AnalyzerConfig {
    ...
    /**
     * Коллеги, которых не нужно учитывать в сводке «Тестировщики без
     * автотестов» HTML-отчёта (например, уволившиеся). Можно указывать
     * e-mail или отображаемое имя из AUTHOR_NAMES. На остальные секции
     * отчёта не влияет.
     */
